...
namespace JustAssets.AtlasMapPacker.Rating
{
    public class AssetReviewHandler
    {
        public const double REMIND_ME_LATER_DAYS = 2;
        
        public static string ProductName { get; } = AtlasMapperWindow.PRODUCT_NAME;
        ...
        private static readonly string SupportPageURL = AtlasMapperWindow.SUPPORT_LINK;

        private static readonly string AssetStoreURL = "https://assetstore.unity.com/packages/tools/utilities/draw-call-optimizer-just-one-click-191806";
